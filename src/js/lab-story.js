class LabStory {
    ...
    async startNewStory() {
        ...
        if (genre === 'custom') {
            ...
            if (!customValue) {
                return this.notify("Por favor, ingresa un género para tu historia.", "warning");
            }
            genre = customValue;
        }
    ...
    updateToggleBtnUI() {
        ...
        btn.innerHTML = this.showText ? 
            '<i class="fas fa-eye-slash mr-2"></i> Ocultar Texto' : 
            '<i class="fas fa-eye mr-2"></i> Mostrar Texto';
    }
